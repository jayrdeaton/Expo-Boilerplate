...
const CONTENT: Record<Tab, string[]> = {
  ...
  grains: [
    'Barley', 'Brown Rice', 'Buckwheat', 'Bulgur', 'Corn', 'Farro', 'Freekeh',
    'Kamut', 'Millet', 'Oats', 'Quinoa', 'Rye', 'Sorghum', 'Spelt', 'Teff',
    'Wheat', 'White Rice', 'Wild Rice',
  ],
}
    ...
    <View style={[styles.fill, { backgroundColor: theme.colors.background }]}>
      <ScrollViewProvider>
        ...
        <ScrollViewFooter style={styles.footer}>
          <Text variant='labelMedium' style={{ color: theme.colors.onSurfaceVariant }}>centerContent · CustomList</Text>
        </ScrollViewFooter>
      </ScrollViewProvider>
    </View>
  )
