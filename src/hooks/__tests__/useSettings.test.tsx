...
describe('useSettings', () => {
  it('returns settings methods and state', () => {
    ...
    expect(result.current).toHaveProperty('cameraRatio')
    expect(result.current).toHaveProperty('cameraTimeout')
    expect(result.current).toHaveProperty('scannerAuto')
    expect(result.current).toHaveProperty('scannerDevice')
    expect(result.current).toHaveProperty('scannerMode')
    expect(result.current).toHaveProperty('scannerTypes')
